...
public class SimpleAnimationStarter extends Application {
     ...
     */
    public void drawFrame(GraphicsContext g, int frameNumber, double elapsedSeconds, int width,
                          int height) {
...
//            oscillationFrameNum =
//                    600 - oscillationFrameNum; // after 300, the values go backwards back to 0
//        }
...
//            oscillationFrameNum =
//                    300 - oscillationFrameNum; // after 150, the values go backwards back to 0
//        }
...
//            oscillationFrameNum =
//                    200 - oscillationFrameNum; // after 100, the values go backwards back to 0
//        }
...
//
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("demo Animation"); // STRING APPEARS IN WINDOW TITLEBAR!
        stage.show();
